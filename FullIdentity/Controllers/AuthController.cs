...
public class AuthController : ControllerBase
{
    ...
    public AuthController(UserManager<AppUser> userManager, ITokenService tokenService, RoleManager<IdentityRole> roleManager)
    {
    ...
    public async Task<IActionResult> Register(SignUpDto signUpDto)
    {
        ...
        if (!await _roleManager.RoleExistsAsync(signUpDto.Role)) return BadRequest(result.Errors);
